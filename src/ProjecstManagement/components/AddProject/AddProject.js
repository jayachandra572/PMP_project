...
class AddProject extends Component{
    ...
    checkProjectTypeError= () =>{
         this.errorMessage.projectTypeError =this.projectType===null;
    }
    ...
    render(){
        ...
        console.log(projectNameEmpty,projectWorkFlowError,projectTypeError,projectDescriptionError)
        return(
            <AddProjectContainer>
            <Header>PROJECT</Header>
             <ProjectNameLabel
               ...
               />
                ...
                />
                {projectNameEmpty&&<Required>Required</Required>}
            <DescriptionLabel
            isImportant = {true}
            ...
            {projectDescriptionError&&<Required>Required</Required>}
             <WorkflowTypeLabel
                    isImportant = {true}
            ...
            <WorkflowType
                ...
                styles = {{
                    ...
                    height:"40px"}}/>
            {projectWorkFlowError&&<Required>Required</Required>}
            ...
            <ProjectType
                ...
                styles = {{
                        ...
                        height:"40px"}}/>
            {projectTypeError&&<Required>Required</Required>}
            <SubmitButton 
                    type = "button" 
                    content = {"Submit"}
