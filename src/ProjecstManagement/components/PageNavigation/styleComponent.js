...
export const PageNumberButton = styled.button`${tw`flex justify-center items-center`}
  width: 24px;
  height: 24px;
  margin:4px;
  border-radius: 2px;
  font-size:12px;
  border: solid 1px ${props=>props.active ?Colors.darkBlueGray:Colors.lightBlueGrey};
...
export const PageNavigationContainer = styled.div`${tw` flex justify-center pt-8`}`