...
export const TaskInfo = styled(Typo12SteelHKGroteskSemiBold)`${tw`text-center h-auto`}
flex-grow:0;
width:60px;`
...
export const TaskDetailsContainer = styled.div`${tw`flex flex-col flex-wrap `}
min-width:300px;
`;

export const DetailsField = styled.div`${tw`flex flex-wrap my-5`};
` 
export const Caption = styled(Typo12SteelHKGroteskSemiBold)`${tw`mt-1`}`
export const CaptionValue = styled.p`${tw`text-justify self-start ml-5`}
