...
import { PROJECT_ROUTE,TASK_ROUTE ,CREATE_WORK_FLOW_ROUTE} from '../constants/RouteConstants'
...
export const createWorkFlowRoute = <Route eaxct path = {CREATE_WORK_FLOW_ROUTE} component = {CreateWorkFlowRoute}/>
